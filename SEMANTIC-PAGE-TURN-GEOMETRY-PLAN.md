...
The catalog-enabled V3 assets measure 32,209 bytes gzip, 12,209 bytes above the
...
the shared route is 32.7 kB gzip; the catalog-free SDK example is 27.5 kB. After
