...
A publication should preserve meaning before it adds motion. Readers can select
this paragraph, link to the heading above it, change its presentation, and
still encounter the same argument.

> A page turn can enrich the experience without becoming the document model.

## What this first slice proves

- Markdown can remain the source of truth.
