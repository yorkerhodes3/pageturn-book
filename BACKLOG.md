...
| V3-415 | P1 | Complete | Extracted typed material, paper, typography, binding, gutter, edge, and fold configuration; added seven live Style presets and session-only test controls; moved image display/style into a compact Graphic handling box beside Typography. |
