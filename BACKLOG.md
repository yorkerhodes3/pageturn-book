...
| V3-419 | P1 | Complete | Added the contextual Copy, Share, Highlight, and Annotate action toolbar with exact-range validation and persistence, adaptive pointer/touch docking and collision avoidance, keyboard entry/roving focus, truthful clipboard fallback, Undo, capability gating, and lifecycle teardown. |
